...
void reconnect() 
{
  ...
  while (!MQTT_CLIENT.connected()) 
  {
    ...
    MQTT_CLIENT.connect("client_iot_vertical_farming_ppu2022_branch1"); // it isn't necessary..
    

    MQTT_CLIENT.subscribe("iot_vertical_farming_ppu2022/branch1/light"); // HERE SUBSCRIBE.
...
void callback(char* topic, byte* payload, unsigned int length) 
{
  ...
  if(stopic=="iot_vertical_farming_ppu2022/branch1/light")
  {
    light=s_message;
  }
...
void loop()
{
  ...
  if (millis() - previous_time > delay_ms) 
  {
    ...
    //------------test set
    do_publish("iot_vertical_farming_ppu2022/branch1/sensor_value",String(serial_string));
    //------------
